...
- Short-term: switch DA parity (enum/String) ✓, name-resolution precedence ✓, override-bridge checks (codegen synthesis ✓, verify expectations ◐), annotation placement matrix (declaration-site duplicates ✓; type-use matrix ◐), generics upper-bound corner cases ✓, full overload tie-breaks ✓.
