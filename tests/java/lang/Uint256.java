...
public final class Uint256 extends UintType<Uint256> {
   ...
   */
  public static Uint256 MAX_VALUE = new Uint256(NumericArrays.maxValue(MAX_WIDTH));

  public static Uint256 ZERO = new Uint256(NumericArrays.ZERO);
  public static Uint256 ONE  = new Uint256(NumericArrays.ONE);
  public static Uint256 TWO  = new Uint256(NumericArrays.TWO);
  ...
  public Uint256 not() {
    return new Uint256(NumericArrays.not(ints, MAX_VALUE.ints));
  }

  public Uint256 and(final Uint256 other) {
    return new Uint256(NumericArrays.and(ints, other.ints));
  }

  public Uint256 or(final Uint256 other) {
    return new Uint256(NumericArrays.or(ints, other.ints));
  }

  public Uint256 xor(final Uint256 other) {
    return new Uint256(NumericArrays.xor(ints, other.ints));
  }
  ...
  public Uint256 setBit(final int bit) {
    ...
    return ((MAX_WIDTH <= bit >>> 5) ? this :
            new Uint256(NumericArrays.setBit(ints, bit)));
  }
  ...
  public Uint256 clearBit(final int bit) {
    ...
    return ((ints.length <= bit >>> 5) ? this :
            new Uint256(NumericArrays.clearBit(ints, bit)));
  }
  ...
  public Uint256 flipBit(final int bit) {
     if(bit < 0)
       throw new ArithmeticException("Negative bit address");
     return ((MAX_WIDTH <= bit >>> 5) ? this :
             new Uint256(NumericArrays.flipBit(ints, bit)));
  }
  ...
  public Uint256 inc() {
    ...
    return new Uint256(NumericArrays.inc(ints, MAX_WIDTH));
  }
  ...
  public Uint256 dec() {
    ...
    return new Uint256(NumericArrays.dec(ints));
  }
  ...
  public Uint256 add(final Uint256 other) {
    ...
    Uint256 maxMinusThis = MAX_VALUE.sub(this);
    if (maxMinusThis.compareTo(other) < 0) {
      throw new ArithmeticException("SafeMath: addition overflow");
    }
    
    return new Uint256(NumericArrays.add(ints, other.ints, MAX_WIDTH));
  }
  ...
  public Uint256 addmod(final Uint256 add, final Uint256 mod) {
    ...
    return new Uint256(NumericArrays.addmod(ints, add.ints, mod.ints));
  }
  ...
  public Uint256 sub(final Uint256 other) {
    ...
    return (cmp == 0 ? ZERO :
            new Uint256(NumericArrays.sub(ints, other.ints)));
  }
  ...
  public Uint256 mul(final Uint256 other) {
    ...
    if (!isZero() && !other.isZero()) {
      Uint256 maxDivThis = MAX_VALUE.div(this);
      if (maxDivThis.compareTo(other) < 0) {
        throw new ArithmeticException("SafeMath: multiplication overflow");
      }
    }
    
    return new Uint256(NumericArrays.multiply(ints, other.ints, MAX_WIDTH));
  }
  ...
  public Uint256 mulmod(final Uint256 mul, final Uint256 mod) {
    ...
    return new Uint256(NumericArrays.mulmod(ints, mul.ints, mod.ints));
  }
  ...
  public Uint256 pow(final int exp) {
    ...
    return (exp == 1 ? this :
            new Uint256(NumericArrays.pow(ints, getLowestSetBit(), exp, MAX_WIDTH)));
  }
   ...
   */
  public Uint256 div(final Uint256 other) {
    ...
    return (cmp < 0 ? ZERO :
            (cmp == 0 ? ONE :
             new Uint256(NumericArrays.divide(ints, other.ints))));
  }
  ...
  public Uint256 mod(final Uint256 other) {
    ...
    return (cmp < 0 ? this :
            (cmp == 0 ? ZERO :
             new Uint256(NumericArrays.mod(ints, other.ints))));
  }
   ...
   * @throws ArithmeticException if overflow occurs
   */
  public static Uint256 mul(Uint256 a, Uint256 b) {
    if (a == null || b == null) {
      throw new IllegalArgumentException("SafeMath: multiplication with null");
    }
    return a.mul(b);
   ...
   */
  public static Uint256 div(Uint256 a, Uint256 b) {
    if (a == null || b == null) {
   ...
   * @throws ArithmeticException if b is zero
   */
  public static Uint256 mod(Uint256 a, Uint256 b) {
    if (a == null || b == null) {
