...
import static java.base.Stream.set4;
...
public class Proxy {
    ...
    throws IOException
  {
    ...
    for (Class c: interfaces) {
      java.base.VMMethod[] ivtable = SystemClassLoader.vmClass(c).virtualTable;
      if (ivtable != null) {
        for (java.base.VMMethod m: ivtable) {
    ...
    Class result = java.base.SystemClassLoader.getClass
      (java.base.Classes.defineVMClass(loader, classData, 0, classData.length));
