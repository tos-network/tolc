...
public class StringBuffer implements CharSequence {
  ...
  public StringBuffer append(char v) {
    sb.append(v);
    return this;
  }

  public StringBuffer append(boolean v) {
    sb.append(v);
    return this;
  }
  ...
  public StringBuffer append(char[] b, int offset, int length) {
    sb.append(b, offset, length);
    return this;
  }

  public StringBuffer append(char[] b) {
  ...
  public StringBuffer insert(int i, String s) {
    sb.insert(i, s);
    return this;
  }
  ...
  public StringBuffer insert(int i, int v) {
    sb.insert(i, v);
    return this;
  }
  ...
  public void getChars(int srcStart, int srcEnd, char[] dst,
                                    int dstStart)
  {
